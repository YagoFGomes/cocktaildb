...
def CriarPaginaDrinks():
    # drinks = ''
    # acumulador_itens_html = ''
    # contador_de_elementos = 0
   
    url_base = "http://www.thecocktaildb.com/api/json/v1/1/filter.php?a=Alcoholic"
    drinks_populares = requests.get(f"{url_base}")
    # print(type(drinks_populares))
